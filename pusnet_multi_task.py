...
parser.add_argument('--sr', default=1.0, type=float, help='sparse ratio')  
...
model_save_path = os.path.join(c.model_dir, 'pusnet', str(args.sr), '3090')
...
if c.mode == 'test':
    # model = torch.load(c.test_pusnet_path)
